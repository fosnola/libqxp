...
class QXP33Header : public QXP3HeaderBase, public std::enable_shared_from_this<QXP33Header>
{
public:
  explicit QXP33Header(const boost::optional<QXPDocument::Type> &fileType = boost::none);
